...
${OBJECTDIR}/_ext/298884965/AES.p1: ../aes/aes_src/AES.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O2 -Og -flocal -maddrqual=ignore -DMBRTU -DDEBUGVECTOR -DSX1276 -xassembler-with-cpp -I"../app/app_inc" -I"../hal/hal_inc" -I"../nwk/nwk_inc" -I"../phy/phy_inc" -I"mcc_generated_files" -I"../modbus/mb_inc" -I"../modbus/port" -I"../modbus/rtu" -I"../modbus/functions" -I"../aes/aes_inc" -I"../wdt/wdt_inc" -I"../memory/eeprom/eeprom_inc" -I"../phy/sx1276/sx1276_inc" -I"../phy/sx1280/sx1280_inc" -I"../sys/sys_inc" -I"../memory/flash/flash_inc" -I"../powerctl/powerctl_inc" -mwarn=-3 -Wa,-a -DXPRJ_MBRTU=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mkeep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=hybrid:auto:auto:auto     -o ${OBJECTDIR}/_ext/298884965/AES.p1 ../aes/aes_src/AES.c 
