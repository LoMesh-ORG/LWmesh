...
${OBJECTDIR}/_ext/298884965/AES.p1: ../aes/aes_src/AES.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -mrom=4000-1FFFF -O2 -fasmfile -flocal -maddrqual=require -DMBRTU -DBOOTABLE -DSX1276 -DFULLFEATURE -xassembler-with-cpp -I"../app/app_inc" -I"../hal/hal_inc" -I"../nwk/nwk_inc" -I"../phy/phy_inc" -I"mcc_generated_files" -I"../modbus/mb_inc" -I"../modbus/port" -I"../modbus/rtu" -I"../modbus/functions" -I"../aes/aes_inc" -I"../wdt/wdt_inc" -I"../memory/eeprom/eeprom_inc" -I"../phy/sx1276/sx1276_inc" -I"../phy/sx1280/sx1280_inc" -I"../sys/sys_inc" -mwarn=-3 -Wa,-a -DXPRJ_MBbootable=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file --fill=0xFF@0x4000:0x1FFFF -mcodeoffset=4000 -mchecksum=4000-1FF7F@1FF80,algorithm=1,width=-2,polynomial=0x1021  -ginhx032 -Wl,--data-init -mno-keep-startup -mdownload -mno-default-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/_ext/298884965/AES.p1 ../aes/aes_src/AES.c 
...
dist/${CND_CONF}/${IMAGE_TYPE}/PIC18F27K42.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/PIC18F27K42.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_MBbootable=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -mrom=4000-1FFFF -O2 -fasmfile -flocal -maddrqual=require -DMBRTU -DBOOTABLE -DSX1276 -DFULLFEATURE -xassembler-with-cpp -I"../app/app_inc" -I"../hal/hal_inc" -I"../nwk/nwk_inc" -I"../phy/phy_inc" -I"mcc_generated_files" -I"../modbus/mb_inc" -I"../modbus/port" -I"../modbus/rtu" -I"../modbus/functions" -I"../aes/aes_inc" -I"../wdt/wdt_inc" -I"../memory/eeprom/eeprom_inc" -I"../phy/sx1276/sx1276_inc" -I"../phy/sx1280/sx1280_inc" -I"../sys/sys_inc" -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file --fill=0xFF@0x4000:0x1FFFF -mcodeoffset=4000 -mchecksum=4000-1FF7F@1FF80,algorithm=1,width=-2,polynomial=0x1021  -ginhx032 -Wl,--data-init -mno-keep-startup -mdownload -mno-default-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/PIC18F27K42.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/PIC18F27K42.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/PIC18F27K42.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/PIC18F27K42.${IMAGE_TYPE}.map  -DXPRJ_MBbootable=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -mrom=4000-1FFFF -O2 -fasmfile -flocal -maddrqual=require -DMBRTU -DBOOTABLE -DSX1276 -DFULLFEATURE -xassembler-with-cpp -I"../app/app_inc" -I"../hal/hal_inc" -I"../nwk/nwk_inc" -I"../phy/phy_inc" -I"mcc_generated_files" -I"../modbus/mb_inc" -I"../modbus/port" -I"../modbus/rtu" -I"../modbus/functions" -I"../aes/aes_inc" -I"../wdt/wdt_inc" -I"../memory/eeprom/eeprom_inc" -I"../phy/sx1276/sx1276_inc" -I"../phy/sx1280/sx1280_inc" -I"../sys/sys_inc" -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file --fill=0xFF@0x4000:0x1FFFF -mcodeoffset=4000 -mchecksum=4000-1FF7F@1FF80,algorithm=1,width=-2,polynomial=0x1021  -ginhx032 -Wl,--data-init -mno-keep-startup -mdownload -mno-default-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/PIC18F27K42.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
