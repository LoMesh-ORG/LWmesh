...
${OBJECTDIR}/_ext/298884965/AES.p1: ../aes/aes_src/AES.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -mrom=4000-1FFFF -O2 -fasmfile -flocal -maddrqual=require -DATCOMM -DBOOTABLE -DSX1280 -xassembler-with-cpp -I"../app/app_inc" -I"../hal/hal_inc" -I"../nwk/nwk_inc" -I"../sys/sys_inc" -I"mcc_generated_files" -I"../modbus/mb_inc" -I"../modbus/port" -I"../modbus/rtu" -I"../modbus/functions" -I"../aes/aes_inc" -I"../wdt/wdt_inc" -I"../memory/eeprom/eeprom_inc" -I"../phy/phy_inc" -I"../phy/sx1276/sx1276_inc" -I"../phy/sx1280/sx1280_inc" -mwarn=-3 -Wa,-a -DXPRJ_atbootable=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file --fill=0xFF@0x4000:0x1FFFF -mcodeoffset=4000 -mchecksum=4000-1FF7F@1FF80,algorithm=1,width=-2,polynomial=0x1021  -ginhx32 -Wl,--data-init -mno-keep-startup -mdownload -mno-default-config-bits -mc90lib $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=hybrid:auto:auto:auto     -o ${OBJECTDIR}/_ext/298884965/AES.p1 ../aes/aes_src/AES.c 
